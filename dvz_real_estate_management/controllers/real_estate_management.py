...
class PropertyController(http.Controller):
    ...
    def property(self):
        ...
        return request.render('dvz_real_estate_management.property_view', {
    ...
    def property_item(self, property_id):
        ...
        return request.render('dvz_real_estate_management.property_view_item',
                              {
    ...
    def auction(self):
        ...
        response = http.Response(
            template='dvz_real_estate_management.auction_view',
            qcontext=context)
